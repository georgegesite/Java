...
public class Practice {
    public static void main(String[] args) {
        ...
        String string = null;
        char[] letters = {'a', 'b', 'c'};
        //string = letters[1] + letters[2]; //incompatible types: int cannot be converted to String - Result is 98 + 99 = 197
        ...
        int z = '8';// unicode value of 56  - assigns the Unicode code point of '8' (which is 56) to z.
        System.out.println(x);
